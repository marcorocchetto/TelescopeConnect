...
os.system("/usr/bin/convert '" + os.path.abspath(json_data['fits_fname']) + "' -linear-stretch 600x1500 -resize 1024x '" + path_jpg_large + "'")
os.system("/usr/bin/convert '" + os.path.abspath(json_data['fits_fname']) + "' -linear-stretch 600x1500 -resize 100x '" + path_jpg_thumb + "'")
