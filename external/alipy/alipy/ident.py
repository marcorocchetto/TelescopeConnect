...
def run(ref, ukns, hdu=0, visu=True, skipsaturated=False, r = 5.0, n=500, sexkeepcat=False, sexrerun=True, verbose=True, stdout_file=None):
	"""
	...
	ref.makecat(rerun=sexrerun, keepcat=sexkeepcat, verbose=verbose, stdout_file=stdout_file)
	...
	for ukn in ukns:
		...
		ukn.makecat(rerun=sexrerun, keepcat=sexkeepcat, verbose=verbose, stdout_file=stdout_file)
